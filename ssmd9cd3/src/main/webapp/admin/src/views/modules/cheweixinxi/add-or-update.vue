<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="车位号" prop="cheweihao">
          <el-input v-model="ruleForm.cheweihao" 
              placeholder="车位号" clearable  :readonly="ro.cheweihao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="车位号" prop="cheweihao">
              <el-input v-model="ruleForm.cheweihao" 
                placeholder="车位号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="车位状态" prop="cheweizhuangtai">
        ...
        <div v-else>
          <el-form-item class="input" label="车位状态" prop="cheweizhuangtai">
          ...
          <el-form-item class="input" label="每天价格" prop="meitianjiage">
              <el-input v-model="ruleForm.meitianjiage" 
                placeholder="每天价格" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="车位位置" prop="cheweiweizhi">
          <el-input v-model="ruleForm.cheweiweizhi" 
              placeholder="车位位置" clearable  :readonly="ro.cheweiweizhi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="车位位置" prop="cheweiweizhi">
              <el-input v-model="ruleForm.cheweiweizhi" 
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.cheweitupian" label="车位图片" prop="cheweitupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.cheweitupian.split(',')" :src="item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
                                                            </el-row>
